...
If you're on Java 10 or later (which you almost certainly are), the JVM already knows it's in a container. You don't need to enable anything — but you still need to configure how it *uses* that knowledge.
