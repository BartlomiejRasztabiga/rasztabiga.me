...
For a full Spring Boot observability stack, see [Observability in 2026](/blog/observability-2026-spring-boot).
...
**Deep dives**
- [Virtual Threads vs Platform Threads — Baeldung](https://www.baeldung.com/java-virtual-thread-vs-thread) — comprehensive comparison of thread models, builder API, and continuations
- [Java Virtual Thread Pinning — Todd Ginsberg](https://todd.ginsberg.com/post/java/virtual-thread-pinning/) — detailed explanation of pinning, JFR detection, and ReentrantLock mitigation
- [JEP 444: Virtual Threads — OpenJDK](https://openjdk.org/jeps/444) — thread-local behavior, migration guidance, and design decisions straight from the JDK team
- [The State of Project Loom with Ron Pressler (nipafx)](https://www.youtube.com/watch?v=KG24inClY2M) — conversation with Project Loom lead on core mission, debugger challenges, GC interaction, and compatibility
...
- [Detecting Virtual Thread Pinning — Liviu Stirb](https://blog.blockingqueue.com/detecting-virtual-thread-pinning-in-java) — practical detection with `-Djdk.tracePinnedThreads` and Java 24+ changes
- [Virtual Threads After JEP 491 — Tiare Balbi](https://tiarebalbi.com/en/blog/virtual-threads-after-jep-491-bottleneck-moved) — what actually breaks in production and how to find the real bottleneck

**Benchmarking**
- [Spring Boot Virtual Threads: Benchmarks and Pitfalls — Devops Monk](https://devops-monk.com/2026/05/spring-boot-virtual-threads/) — real benchmark numbers comparing platform threads, virtual threads, and WebFlux
- [Java 25 Virtual Threads: Benchmarks and Pitfalls — Spring Java Lab](https://www.springjavalab.com/2025/12/java-25-virtual-threads-benchmarks-pitfalls.html) — what breaks in production, database pool pitfalls, and ThreadLocal issues
- [JMH — OpenJDK](https://github.com/openjdk/jmh) — use JMH to benchmark your specific workload before and after migration
